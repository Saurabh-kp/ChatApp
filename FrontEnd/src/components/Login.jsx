    ...
    <>
      <div className='flex h-screen justify-center items-center bg-gray-900'>
        <form onSubmit={handleSubmit(onSubmit)} className='border m-3 border-white px-6 py-2 rounded-md space-y-3 w-96'>
          <h1 className='text-2xl text-center text-gray-300'>Chat
          ...
          <div className='flex justify-between'> 
            <p className='text-gray-300'>New User?<Link to="/signup" className='text-blue-500 underline cursor-pointer ml-1'>Signup</Link></p>
            <input type="submit" value="Login" className='text-white bg-green-500 px-4 py-1 rounded-lg cursor-pointer hover:bg-green-700' />
          </div>
        </form>
      </div>
    </>
